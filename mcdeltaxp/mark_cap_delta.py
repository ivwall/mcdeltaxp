...
class MCDelta():
    ...
    def write_mcdelta_html_from_11json_data():
        ...
        f.write("  <br/>")
        f.write("  Jun 22<br/>")
        f.write("       STEEM, https://steem.com/, among others Dtube - decentrailized tube.<br/>")
        ...
        f.write("       Web5<br/>")
        f.write("          v<br/>")
        f.write("       EMAID, https://maidsafe.net/, the world’s first autonomous and decentralised data network.<br/>")
        f.write("  <br/>")
