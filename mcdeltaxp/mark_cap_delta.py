...
class MCDelta():
    ...
    def write_mcdelta_html_from_11json_data():
        ...
        f.write("  <br/>")
        f.write("  Feb 11<br/>")
        f.write("  PGIRL -- first NTF that looks interesting<br/>")
        f.write("  <br/>")
        f.write("  other interesting $#!^ coins<br/>")
        f.write("  FLOW, on cro, dapperlabs invested says 500+ dev, 100+ known projects and Dapps; games, NTFs, Defi, tools at ~7.30 <br/>")
        f.write("  STX, on CRO, stacks.co, stacking, a new way to earn bitcoin.<br/>")
